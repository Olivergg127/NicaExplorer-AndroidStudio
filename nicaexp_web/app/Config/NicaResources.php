    ...
    public function all(): array
    {
        return [
            'ciudades' => [
                ...
                'id'           => ['strategy' => 'manual', 'label' => 'ID (ej. juigalpa)', 'editable' => false],
                'title_field'  => 'nombre',
                ...
                'fields'       => [
                    ...
                    'imagenKey'     => ['label' => 'Imagen local (clave, legado)', 'type' => 'string'],
            ...
            'categorias_lugares' => [
                ...
                'singular'     => 'Categoría',
                'icon'         => 'bi-tags',
                'description'  => 'Catálogo de categorías usadas por los lugares turísticos.',
            ...
            'lugares' => [
                ...
                'id'           => ['strategy' => 'manual', 'label' => 'monumentId (ej. toro_chontaleno)', 'editable' => false],
                'title_field'  => 'nombre',
            ...
            'rutas' => [
                ...
                'id'           => ['strategy' => 'auto', 'label' => 'ID de ruta (opcional)', 'editable' => false],
                'title_field'  => 'nombre',
